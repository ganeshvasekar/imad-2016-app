...
function createTemplate (data) {
    ...
    <html>
      ...
      <div>
          ...
          <div style= "padding-right:40px; padding-left:40px; padding-top:85px; background-color:#FFFFFF; ">
...
app.get('/logout', function (req, res) {
   ...
   res.send('<html><body>Logged out!<br/><br/><a href="/page3">Back to Login</a></body></html>');
});
